...
Examples:
  ...
  python script.py -C "session=abc123;user=john" -H "Authorization: Bearer token" example.com
  python script.py -p 127.0.0.1:8080 -t 15 https://example.com
  python script.py -p http://user:pass@127.0.0.1:8080 https://example.com
  python script.py -s --sleep 3 -e "PHPSESSID,session_id" https://example.com
"""
    print(help_text)
